...
MARKER_KEYS = {
    ...
    "DRIVE_ECO_VISIBLE": ["operation_raw"],
    "OEM_NORMAL_VISIBLE": ["operation_raw"],
    "DRIVE_SPORT_VISIBLE": ["operation_raw"],
    "REGEN_HIGH_VISIBLE": ["energy_feedback_raw"],
...
DISTINCT_GROUPS = {
    ...
    "drive_modes": ["DRIVE_ECO_VISIBLE", "OEM_NORMAL_VISIBLE", "DRIVE_SPORT_VISIBLE"],
    "regen_modes": ["OEM_STANDARD_VISIBLE", "REGEN_HIGH_VISIBLE"],
